            ...
            if(count!=null){
                for(Customer customerObj:customerList){
                    if(customerObj.getOrderNo()==count){
                        System.out.println("THis is Order:"+customerObj.getOrderNo());
                        System.out.println("This is the total: "+customerObj.getTotalPrice());
                        nSession.setAttribute("customer", customerObj);
